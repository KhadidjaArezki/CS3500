...
/** Because we do not know how you are choosing to implement spreadsheets, we will provide you with the
 * class WorksheetReader.
 * In design-pattern terms, WorksheetReader is a factory: if you provide it with a builder of worksheets,
 * it can construct a model worksheet for you.
 * 
 * The {@link read} method is parameterized by whatever type you choose to implement your spreadsheets.
 * It will read the contents of the provided Readable, and determine the contents of your spreadsheet.
 * In order to actually build the spreadsheet, though, it relies on a builder that you must implement and supply.
 *
